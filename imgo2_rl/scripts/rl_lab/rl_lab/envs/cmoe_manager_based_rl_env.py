...
class CMoEManagerBasedRLEnv(ManagerBasedRLEnv):
    """CMoE environment that exposes terminal observations before Isaac Lab auto-reset."""
    
    def __init__(self, cfg, render_mode: str | None = None, **kwargs) -> None:
        """Initialize the CMoE environment.
