...
class CMoERolloutStorage:
    ...
    def __init__(self, num_envs, num_transitions_per_env, obs_shape, privileged_obs_shape, actions_shape, device='cpu'):
        ...
        # Core
        self.observations = torch.zeros(num_transitions_per_env, num_envs, *self.obs_shape, device=self.device)
        if privileged_obs_shape is not None and privileged_obs_shape[0] is not None:
