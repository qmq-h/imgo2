...
from imgo2_rl.tasks.manager_based.locomotion.velocity.velocity_env_cfg import CommandsCfg, LocomotionVelocityRoughEnvCfg
...
from .env import commands


class Imgo2HeightMoveCommandsCfg(CommandsCfg):
    pass

@configclass
class Imgo2HeightRoughEnvCfg(LocomotionVelocityRoughEnvCfg):
    base_link_name = "base"
    ...
    def __post_init__(self):
        ...
        if self.__class__.__name__ == "Imgo2HeightRoughEnvCfg":
