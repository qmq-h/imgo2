...
| `Imgo2-basemove-rough-amp` | `scripts/rl_lab/amp/train.py`（**粗糙地形版 AMP-only**：配方与 `flat-amp` 完全相同，只加地形 + 地形相对高度 + 关参考状态初始化；actor 保持 45 维盲走，2026-09-18 新增） |
...
python scripts/rl_lab/amp/train.py --task=Imgo2-basemove-rough-amp --num_envs=256 --max_iterations=100 --seed=42 --headless
