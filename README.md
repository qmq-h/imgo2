...
| `3` | `RLFSMStateAMPLocomotion` | `policy/imgo2/amp/` | 45 维（无 `base_lin_vel`，与参考 `amp_go2` 的 actor 组成一致） | `policy.pt`（`model_5000.pt` 导出，sha256 `0e5bd661b1591a87…`；2026-09-18 首测四项指标见 [Gazebo 记录](docs/gazebo_ros2_bringup_2026-09-17.md) 第 9 节） |
